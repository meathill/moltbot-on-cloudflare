/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8a4b5c05338fe701439b3f99e44adeae)
// Runtime types generated with workerd@1.20260124.0 2026-01-01 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/index');
    durableNamespaces: 'MoltbotContainer';
  }
  interface Env {
    SERVER_USERNAME: 'meathillbot';
    S3_ENDPOINT: 'https://fdc63eeea83ae8f5234357308b9a638b.r2.cloudflarestorage.com';
    S3_BUCKET: 'moltbot';
    S3_REGION: 'auto';
    S3_ACCESS_KEY_ID: string;
    S3_SECRET_ACCESS_KEY: string;
    MOLTBOT_CONTAINER: DurableObjectNamespace<import('./src/index').MoltbotContainer>;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        'SERVER_USERNAME' | 'S3_ENDPOINT' | 'S3_BUCKET' | 'S3_REGION' | 'S3_ACCESS_KEY_ID' | 'S3_SECRET_ACCESS_KEY'
      >
    > {}
}
